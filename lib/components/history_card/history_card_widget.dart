...
class HistoryCardWidget extends StatefulWidget {
  const HistoryCardWidget({
    ...
    String? profession,
    String? title,
  })  : this.amount = amount ?? '4,500',
        this.cardId = cardId ?? 'h1',
        this.date = date ?? '24 Oct 2023',
        this.location = location ?? 'चौपाल नंबर 3',
        this.profession = profession ?? 'चिणाई मिस्तरी',
        this.title = title ?? 'चिणाई का काम (Wall Plastering)';
