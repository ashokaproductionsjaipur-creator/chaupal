...
class _LoginScreenWidgetState extends State<LoginScreenWidget> {
  ...
  @override
  void initState() { super.initState(); _model = createModel(context, () => LoginScreenModel()); }
  @override
  ...
  Future<void> _login() async {
    ...
    try {
      final r = await http.post(
        ...
        body: jsonEncode({'username': username, 'password': password, 'role': selectedRole}),
      );
      dynamic body;
      try { body = jsonDecode(r.body); } catch (_) { body = null; }
      ...
      if (accessToken == null || refreshToken == null || userId == null || rawUser is! Map) {
