    ...
    return Scaffold(
      ...
      body:FutureBuilder<Map<String,dynamic>>(
        ...
        builder:(context,snapshot){
          ...
          final jobs=((d['jobs'] as List?)??[]).map((e)=>Map<String,dynamic>.from(e as Map)).toList();
          ...
          return RefreshIndicator(
            ...
            child:ListView(
              ...
              children:[
                ...
                const SizedBox(height:14),
                SizedBox(height:52,child:FilledButton.icon(onPressed:canPost?()=>context.goNamed(CreateJobPostWidget.routeName):null,icon:const Icon(Icons.add),label:const Text('Create Job | जॉब पोस्ट करो'))),
                ...
                ...jobs.map((j){
                  return Card(
                    ...
                    shape:RoundedRectangleBorder(borderRadius:BorderRadius.circular(12),side:BorderSide(color:t.alternate)),
                    child:ListTile(
