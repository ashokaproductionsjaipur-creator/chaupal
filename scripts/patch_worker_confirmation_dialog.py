...
elif old_init_previous in s:
    s = s.replace(old_init_previous, new_init, 1)
...
if '_showPendingConfirmation()' not in s:
  ...
  void dispose() {
'''
    popup = '''  Future<void> _showPendingConfirmation() async {
